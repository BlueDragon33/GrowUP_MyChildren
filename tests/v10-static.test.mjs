...
test('service worker and package agree on v1.1 runtime modules and cache',async()=>{
  ...
  for(const path of ['runtime-entry.js','runtime.css','v11-runtime.js','portability-map.js','family-workload.js','saved-search.js','recovery-schedule.js','runtime-compatibility.js']) assert.ok(sw.includes(path));
