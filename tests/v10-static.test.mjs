...
test('runtime entry imports compatibility layers once and in release order',async()=>{
  ...
  const expected=['./app.js','./enhancements.js','./v4.js','./v5.js','./v6.js','./v7.js','./v8.js','./v9-runtime.js','./v9-compat.js','./v10-runtime.js','./v11-runtime.js','./v12-runtime.js','./v13-runtime.js','./v14-runtime.js','./v15-runtime.js','./v16-runtime.js','./v16-guard.js','./v17-runtime.js','./v18-runtime.js','./v19-runtime.js','./v110-runtime.js','./a11y.js'];
...
test('service worker and package agree on v1.10 runtime modules and cache',async()=>{
  ...
  assert.match(sw,/growup-mychildren-v110/);
  for(const path of ['runtime-entry.js','runtime.css','v19-runtime.js','v110-runtime.js','receipt-history-verification-receipt-package-integrity.js','workload-preset-import-audit-review-package-integrity.js','saved-search-receipt-history-package-verification-receipts.js','recovery-verification-package-receipt-management.js','compatibility-axe-recheck-management.js']) assert.ok(sw.includes(path));
  for(const path of ['src/runtime-entry.js','src/v19-runtime.js','src/v110-runtime.js','src/core/receipt-history-verification-receipt-package-integrity.js','src/core/workload-preset-import-audit-review-package-integrity.js','src/core/saved-search-receipt-history-package-verification-receipts.js','src/core/recovery-verification-package-receipt-management.js','src/core/compatibility-axe-recheck-management.js']) assert.ok(pkg.scripts.check.includes(path));
  assert.match(release,/APP_VERSION = '1\.10\.0'/);
  assert.match(release,/7740f7ec90992811fd0ea66b0654086dcc25d116/);
  assert.match(rc,/growup-mychildren-v110/);
  assert.match(rc,/7740f7ec90992811fd0ea66b0654086dcc25d116/);
});
