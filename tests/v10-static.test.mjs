...
test('runtime entry imports compatibility layers once and in release order',async()=>{
  ...
  const expected=['./app.js','./enhancements.js','./v4.js','./v5.js','./v6.js','./v7.js','./v8.js','./v9-runtime.js','./v9-compat.js','./v10-runtime.js','./v11-runtime.js','./v12-runtime.js','./v13-runtime.js','./v14-runtime.js','./v15-runtime.js','./v16-runtime.js','./v16-guard.js','./v17-runtime.js','./v18-runtime.js','./a11y.js'];
...
test('service worker and package agree on v1.8 runtime modules and cache',async()=>{
  ...
  for(const path of ['runtime-entry.js','runtime.css','v17-runtime.js','v18-runtime.js','receipt-import-history-package-integrity.js','workload-preset-import-audit-package-integrity.js','saved-search-receipt-import-history.js','recovery-reconciliation-verification-receipt-management.js','compatibility-evidence-freshness-policy.js']) assert.ok(sw.includes(path));
