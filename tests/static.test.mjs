...
test('service worker caches active v110 runtime and waits for explicit update approval', async () => {
  const sw = await read('sw.js');
  for (const asset of ['runtime-entry.js','runtime.css','v19-runtime.js','v110-runtime.js','receipt-history-verification-receipt-package-integrity.js','workload-preset-import-audit-review-package-integrity.js','saved-search-receipt-history-package-verification-receipts.js','recovery-verification-package-receipt-management.js','compatibility-axe-recheck-management.js','v9-runtime.js','v9-compat.js']) assert.ok(sw.includes(asset));
...
test('package and CI pin the current v1.10 release-candidate tooling profile', async () => {
