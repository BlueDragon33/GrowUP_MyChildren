...
test('service worker caches active v17 runtime and waits for explicit update approval', async () => {
  ...
  for (const asset of ['runtime-entry.js','runtime.css','v16-runtime.js','v16-guard.js','v17-runtime.js','export-verification-import-history.js','workload-preset-import-history.js','saved-search-integrity-receipt-package.js','recovery-reconciliation-report-integrity.js','compatibility-evidence-import-audit.js','v9-runtime.js','v9-compat.js']) assert.ok(sw.includes(asset));
