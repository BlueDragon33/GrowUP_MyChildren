...
test('document exposes Vietnamese language, viewport and v6 runtime assets', async () => {
  ...
  for (const asset of ['enhancements.css','enhancements.js','v4.css','v4.js','v5.css','v5.js','v6.css','v6.js','a11y.js']) {
...
test('service worker caches every v6 runtime module', async () => {
  ...
  for (const asset of ['enhancements.js','v4.js','v5.js','v6.js','a11y.js','schema.js','analytics.js','calendar.js','attachments.js','integrations.js','privacy.js','roles.js','reminders.js','backup.js','templates.js','report.js','timeline.js','evidence.js','family-policy.js','export.js','evidence-repair.js','archive.js','timeline-filter.js']) {
