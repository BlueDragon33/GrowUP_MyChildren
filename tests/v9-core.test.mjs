...
test('RC consistency profile passes only matching configuration',()=>{
  const pass=evaluateReleaseCandidate({appVersion:'1.1.0',dataSchemaVersion:5,serviceWorkerCache:'growup-mychildren-v11',nodeMajor:22,playwrightVersion:'1.55.0',axePlaywrightVersion:'4.10.2',rollbackCommit:'605c4948cbcc60164d8a34ba220558d39d8eeeb5'});
  assert.equal(pass.ready,true);
  const fail=evaluateReleaseCandidate({appVersion:'1.1.0',dataSchemaVersion:5,serviceWorkerCache:'wrong',nodeMajor:20,playwrightVersion:'1.55.0',axePlaywrightVersion:'4.10.2',rollbackCommit:'wrong'});
