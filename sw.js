...
const ASSETS = [
  ...
  './src/runtime.css', './src/styles.css', './src/enhancements.css', './src/v4.css', './src/v5.css', './src/v6.css', './src/v7.css', './src/v8.css', './src/v9.css', './src/v10.css', './src/v11.css', './src/v12.css', './src/v13.css', './src/v14.css', './src/v15.css', './src/v16.css', './src/v17.css',
  ...
  './src/core/export-wizard.js', './src/core/export-integrity.js', './src/core/export-verification-history.js', './src/core/export-verification-management.js', './src/core/export-verification-package-integrity.js', './src/core/export-verification-import-history.js',
  ...
  './src/core/saved-search-organizer.js', './src/core/saved-search-package.js', './src/core/saved-search-package-integrity.js', './src/core/saved-search-integrity-receipt-management.js', './src/core/saved-search-integrity-receipt-package.js',
  './src/core/compatibility-evidence.js', './src/core/compatibility-evidence-store.js', './src/core/compatibility-evidence-package.js', './src/core/compatibility-evidence-import-audit.js', './src/core/retirement-review.js', './src/core/retirement-dry-run.js',
