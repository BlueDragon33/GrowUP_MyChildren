const CACHE = 'growup-mychildren-v11';
const ASSETS = [
  './', './index.html', './app.webmanifest', './assets/icon.svg',
  './src/runtime.css', './src/styles.css', './src/enhancements.css', './src/v4.css', './src/v5.css', './src/v6.css', './src/v7.css', './src/v8.css', './src/v9.css', './src/v10.css', './src/v11.css',
  './src/runtime-entry.js', './src/app.js', './src/enhancements.js', './src/v4.js', './src/v5.js', './src/v6.js', './src/v7.js', './src/v8.js', './src/v9-runtime.js', './src/v9-compat.js', './src/v10-runtime.js', './src/v11-runtime.js', './src/a11y.js',
  ...
  './src/core/data-portability.js', './src/core/workload-windows.js', './src/core/saved-searches.js', './src/core/recovery-schedule.js', './src/core/compatibility-usage.js',
